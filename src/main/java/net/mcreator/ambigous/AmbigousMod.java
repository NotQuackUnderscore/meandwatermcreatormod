...
@Mod("ambigous")
public class AmbigousMod {
	public static final Logger LOGGER = LogManager.getLogger(AmbigousMod.class);
	public static final String MODID = "ambigous";

	public AmbigousMod(IEventBus modEventBus) {
